...
npm run e2e           # Playwright end-to-end tests (47 tests: 38 baseline + 9 v0.4)
```
...
├── playwright.config.ts      # Playwright e2e config (47 tests)
...
│   └── v0.4-features.spec.ts # v0.4 Work CRUD + Work filter tests (9 tests)
└── src/
...
| `e2e` | `playwright test` | Run Playwright e2e tests (47 total) |
